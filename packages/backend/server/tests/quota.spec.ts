...
test('should be able to set quota', async t => {
  ...
  // TODO: fix quotas
  t.is(q1?.feature.name, QuotaType.PersonalWorkspace, 'should be free plan');
  ...
  t.is(q2?.feature.name, QuotaType.TeamWorkspace, 'should be pro plan');
...
test('should be able revert quota', async t => {
  ...
  t.is(quotas[0].feature.name, QuotaType.PersonalWorkspace, 'should be free plan');
  t.is(quotas[1].feature.name, QuotaType.TeamWorkspace, 'should be pro plan');
  t.is(quotas[2].feature.name, QuotaType.PersonalWorkspace, 'should be free plan');
